...
<t:admin>
    ...
    <jsp:body>
        ...
        <div class="history-image">
            ...
            <div class="title-box bg-danger mt-3 w-75 mx-auto justify-content-center" style="border-radius: 5px; font-family: 'Russo One',sans-serif; background-image: url('https://www.thebutlerspantry.ie/wp-content/uploads/2020/10/trim-header-christmas.png');background-size: cover">
                <h2>Feedback to you</h2>
            </div>

            <div >
                <div class=" text-center w-75 mx-auto" style="background-color: white">
                    <b >
                        <script>
                            let countlike = 0;
                            let countdislike = 0;
                ...
                <div  class="tableFixHistory h-50 w-75 mx-auto" style="cursor: pointer;background-color: white" id="tableFixHistory2;">
            ...
            <div class="title-box bg-danger mt-4 w-75 mx-auto justify-content-center" style="border-radius: 5px; font-family: 'Russo One',sans-serif; background-image: url('https://www.thebutlerspantry.ie/wp-content/uploads/2020/10/trim-header-christmas.png');background-size: cover">
                <h2>Your Feedback</h2>
            </div>
            <div  class="tableFixHistory h-50 w-75 mx-auto" style="cursor: pointer; background-color: white" id="tableFixHistory1">
                <table class="table table-hover " >
                    <thead>
                    <tr>
